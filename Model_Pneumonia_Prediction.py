...
train_path = 'D:/Winter 2023/MSID/pneumonia code/train'
valid_path = 'D:/Winter 2023/MSID/pneumonia code/chest_xray/val'

vgg = VGG16(input_shape=IMAGE_SIZE + [3], weights='imagenet', include_top=False)

for layer in vgg.layers: layer.trainable = False

folders = glob('D:/Winter 2023/MSID/pneumonia code/train/*')
...
test_set = test_datagen.flow_from_directory('D:/Winter 2023/MSID/pneumonia code/test', target_size = (224, 224), batch_size = 10, class_mode = 'categorical')
training_set = train_datagen.flow_from_directory('D:/Winter 2023/MSID/pneumonia code/chest_xray/train', target_size = (224, 224), batch_size = 10, class_mode = 'categorical')
...
img=image.load_img('D:/Winter 2023/MSID/pneumonia code/chest_xray/test/PNEUMONIA/person38_virus_83.jpeg',target_size=(224,224))
